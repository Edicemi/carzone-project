...
def inquiry(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request, 'You have already made an enquiry about this car, please wait until we get back to you. Thanks!')
        ...
        send_mail(
            'New car inquiry',
            'You have a new inquiry for the car' + car_title + '.Please login into your admin panel for more info.',
            'victoriataiwo1998@gmail.com',
            [admin_email],
            fail_silently=False,
        )
